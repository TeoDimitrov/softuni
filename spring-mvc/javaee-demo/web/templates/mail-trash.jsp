        ...
        <div class="row">
            <nav class="col-sm-3 col-md-2 hidden-xs-down bg-faded sidebar">
                ...
                <ul class="nav nav-pills flex-column red">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="/mail/trash">Trash </a>
                    </li>
                </ul>
            </nav>
        </div>
                ...
                <c:forEach items="${emails}" var="email">
                    <tr>
                        <div class="row">
                            ...
                            <div class="col-sm-1">
                                <td>
                                    <a href="/mail/delete/${email.id}" class="btn btn-danger">Delete</a>
                                </td>
                            </div>
                            <div class="col-sm-1">
                                <td>
                                    <a href="/mail/restore/${email.id}" class="btn btn-success">Restore</a>
                                </td>
                            </div>
                        </div>
                    </tr>
